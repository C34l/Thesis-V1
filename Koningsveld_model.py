...
x_output_beta = h.spo.root(phase_balance_for_x, x_1_beta_test, args=(x_1_alpha, t_exp_01593), method='lm')
print('point_beta:',x_output_beta.x,'temp:',t_exp_01593)

x_output_alpha = h.spo.root(phase_balance_for_x, x_1_alpha_test, args=(x_output_beta.x, t_exp_01593), method='lm')
print('point_alpha:',x_output_alpha.x,'temp:',t_exp_01593)
