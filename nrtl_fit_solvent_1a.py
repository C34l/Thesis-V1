...
class NrtlFit:
    ...
    def parametersH2O(datain):
            ...
            _gRSa = h.np.array([_gabRS, _gbaRS, _Alpha])
            _alphaabR = 0.4
            _alphabaR = 0.4
            _gabR = -3500.0
            _gbaR = 9000.0
            # _gRa = h.np.array([_gabR, _gbaR, _alphaabR, _alphabaR])
            _gRa = h.np.array([_gabR, _gbaR, _Alpha])
            ...
            def r_ma():
                ...
                for x in range(steps_t):
                    ...
                    _gamma[x] = h.np.exp(NrtlFit.y_nrtl(_gneu, _xr[x], _tcalc,))
    ...
    def _parameters_lak(datain):
        ...
        _bnds = ((None, None), (None, None), (0.1, 0.5))
